    ...
    <section class="clean-block clean-form dark">
        <div class="container fw-light">
            <div class="block-heading">
                <h2 style="text-align: center"><strong>Login Failed.  Please Try Again</strong><br><br> </h2>
            ...
            <form action="login" method="POST">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a class="btn btn-primary" style="background-color: #087f5b" role="button" href="/index" type="submit">Cancel</a>
            </form>
        </div>
    </section>
@endsection
